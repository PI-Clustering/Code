...
def add_node_rec(cluster, node):
    ...
    if cuts != []:
        ...
        cuts[0] = 0 # We set this value in order to be sure to find a place for the node
        ...
        raise Exception("We shouldn't be in this situation, as the minimum distance, 0, is supposed to be reached")
